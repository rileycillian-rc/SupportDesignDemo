...
public class TouchPaint extends GraphicsActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add(0, CLEAR_ID, 0, "Clear").setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        menu.add(0, FADE_ID, 0, "Fade").setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
    ...
    class PaintView extends View {
        ...
        private boolean onTouchOrHoverEvent(MotionEvent event, boolean isTouch) {
            ...
            if (action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_MOVE
                ...
                final int N = event.getHistorySize();
                Log.e(VIEW_LOG_TAG, "history size is "+N);
        ...
        private void paint(PaintMode mode, float x, float y, float pressure,
        	...
        	Log.e(VIEW_LOG_TAG, "pressure is "+pressure);
            if (mBitmap != null) {
                if (major <= 0 || minor <= 0) {
